...
<h1 align="center" class="h1">Programming Language</h1>
<div class="box-container">

<?php
   $show_subjects = $conn->prepare("SELECT * FROM `subjects` where category='programming'  ");
...
<button class="Btn programs" name="sub">Enroll Now</button>
</form>
</div>
<?php
      }
