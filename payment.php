...
if (isset($_POST['submit'])){
  ...
  $conn = mysqli_connect($host, $user, $password, $database);
    ...
    $sql = "INSERT INTO payinfo(name,number,Expiry,cvv) VALUES ('$name','$number','$expiry','$cvv')";
        ...
        <form class="form" action="#" method="POST" id="">
            ...
            <div class="credit-card-info--form">
                <div class="input_container">
                    ...
                    <input id="password_field" class="input_field" type="text" name="name" title="Inpit title"
                        placeholder="Enter your full name">
                </div>
                <div class="input_container">
                    <label for="password_field" class="input_label">Card Number</label>
                    <input id="password_field" class="input_field" type="number" name="number" title="Inpit title"
                        placeholder="0000 0000 0000 0000">
                </div>
                <div class="input_container">
                    <label for="password_field" class="input_label">Expiry Date / CVV</label>
                    <div class="split">
                        <input id="password_field" class="input_field" type="text" name="Expiry" title="Expiry Date"
                            placeholder="01/23">
            ...
            <button class="purchase--btn" name="submit">PAY</button>
        </form>
    </div>
</body>
