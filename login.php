...
if(isset($_POST['sub'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      echo '
      <div class="message">
         <span>email or number already exists!</span>
         <i class="cross" onclick="this.parentElement.remove();"> ❌ </i>
      </div>
      ';
...
<div class="bo">
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="images/frontImg.jpg" alt="" style="background-color:purple;">
        <div class="text">
      ...
      <div class="back">
        <img class="backImg" src="images/backImg.jpg" alt="" style="background-color:purple;">
        <div class="text">
